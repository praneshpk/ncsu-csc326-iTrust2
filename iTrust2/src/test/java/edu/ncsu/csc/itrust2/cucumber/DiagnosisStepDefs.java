...
//    	if(User.getByName("hcp") == null || User.getByName("admin") == null || User.getByName("patient") == null ){
//        HibernateDataGenerator.refreshDB();
//
...
//    	}
    ...
    public void documentOV () throws InterruptedException {
        ...
        //final WebElement patient = driver.findElement(By.id("AliceThirteen"));
    	final WebElement patient = driver.findElement(By.xpath("//*[text()[contains(.,'AliceThirteen')]]"));
    	//( (JavascriptExecutor) driver ).executeScript( "document.getElementById('AliceThirteen').click();" );
        //patient.click();
    	//((JavascriptExecutor) driver).executeScript("arguments[0].checked = true;", patient);
        //assertTrue(patient.getText().equals("AliceThirteen"));
        ...
        //assertTrue(systolicElement.isDisplayed());
       ...
       // ( (JavascriptExecutor) driver ).executeScript( "document.getElementByName('diastolic').clear();" );
       // ( (JavascriptExecutor) driver ).executeScript( "document.getElementByName('diastolic').sendKeys(100);" );
    ...
    public void navigateViewOV () {
    	...
    	driver.get(baseUrl + "/patient/viewOfficeVisits");
    }
    ...
    public void seeCorrectDiagnosis ( final String correctDiagnosis ) {
       ...
       // final WebElement visits = driver.findElement( By.name( "12/19/" + (this.year - 1)) );
